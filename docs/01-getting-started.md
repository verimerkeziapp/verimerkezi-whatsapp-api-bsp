...
> ⚠️ **Anahtarı güvenli yerde saklayın.** Tekrar gösterilmez. Kaybederseniz iptal edip yenisini oluşturun.
...
> ⚠️ **24 saat kuralı:** Müşteriniz size son 24 saat içinde mesaj atmadıysa, sadece **onaylı bir şablon** ile mesaj gönderebilirsiniz. Düz metin ancak service window içinde çalışır.
